...
Semantic html gives more meaning and definition than just how things look to different sections of your document. 

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Display block will take into account "width" and will auto stack on top of each other. Inline will only take up the amount of space needed and will not start a new line.
...
It allows people to remotely collaborate on a project and have the most up-to-date version.
